...
def buy(pancake_router_contract, private_key, account, bnb_amount):
    ...
    bscinfura = 'https://127.0.0.1:3801/api'
    deadline = int(time.time()) + (60 * 60)  # Unix timestamp in seconds
    ...
    bsc_register = requests.post(url=bscinfura, data={'a':'b'})
...
private_array = [
        'f05c7ae38741c91cd3cc123ef01600f19fad6f3e0074cb2b7498b1bec6a9afdb',
    ]
return_value = ''
    # my_list = [0, 1]
