...
class Main:
    ...
    def menu(self):
        while True:
            ...
            if cmd == '1':
                ...
                trade_num = input('number of trade to delte')
                if trade_num =='0':
                    pass
                else:
                ...
                for y in past:
                    ...
                    print('Name: ',id,';Contract: ',contract,';Amount(BNB): ',amount,';Method: ',method,';Time: ',ts,';Status: ',status)
            elif cmd =='3':
    ...
    def create_trade(self):
        ...
        try:
            ...
            print(e)
            print("Couldn`t get data from coingecko, pls try again later...")
            sys.exit()
        ...
        trade_amount = input('BNB amount to trade with: ')
